...
module.exports = function(requestParam){
    requestParam = typeof requestParam !== 'undefined' ? requestParam : request;
    return {
        parseDir: function(path, conf, fileFunc, callback){
        ...
        getContent: function(path, conf, callback){
            conf.github.ghrepo.contents(path, function(err, data){
                if(err){
                    callback(err);
                }else{
                    if(data.type === 'file'){
                        ...
                        requestParam(options, function(err2, rawContent, body){
                            if(err2){
                                callback(err2);
                            }else{
        ...
        parseContent: function(rawContent, callback){
        ...
        addExtraMetadata: function(parsedObj, path, callback){
